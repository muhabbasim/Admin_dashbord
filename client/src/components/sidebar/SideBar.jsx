        ...
        >
          <Box width="100%">
            <Box m='30px 40px'>
              <FlexBetween>
                <Box>
                  <Typography sx={{ marginLeft:"20px"}} textAlign='center' variant='h4' fontWeight={'bold'}>
                    MANAGERIAL
                  </Typography>
                </Box>
                {!isNonMobile && (
            ...
            <List>
              {navItems.map(({ text , icon }) => {
                if(!icon) {
                  return (
                    <Typography key={text} sx={{ m: "15px 60px" }} fontWeight={'bold'}>
                      {text}
                    </Typography>
                  )
                }
          ...
          <Box >
            <Divider/>
            <FlexBetween gap='0px' m='20px 45px' >
              <Box
                component="img"
                alt="profile"
                src={profileImage}
